		...
		<table id="minhas-atividades">
			...
			<tbody>
				<?php
					...
					$result = mysql_query("select * from `atividades` where idatividade IN (SELECT idatividade FROM participa WHERE idusuario = {$idusuario}) ") or die(mysql_error());
					...
					while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
						...
						echo "Você ainda não escolheu nenhuma atividade que não seja sua para participar";
						echo "</td>";
						echo "</tr>";
				}
				?>
